...
window.EXPORT_URL = window.EXPORT_URL || '/graphEditor/export';
window.SAVE_URL = window.SAVE_URL || '/graphEditor/save';
window.OPEN_URL = window.OPEN_URL || '/graphEditor/open';
